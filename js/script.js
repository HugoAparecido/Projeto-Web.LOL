...
const link_pagina_nav_li1 = document.querySelector("li.link-pagina-nav-li1");
const link_pagina_nav_li2 = document.querySelector("li.link-pagina-nav-li2");
const form_pesquisa = document.querySelector(".form-li");
